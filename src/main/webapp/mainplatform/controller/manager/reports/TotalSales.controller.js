sap.ui.define([
	...
	"use strict";
	return BaseController.extend("ecu.controller.manager.reports.TotalSales",{
		vizFrame : null,
		day_f : null,
		month_f: null,
		year_f: null,
		...
		onInit : function(){
            ...
            oTarget = oRouter.getTarget("totalSales"); //wskazać stronę w routingu
            oTarget.attachDisplay(function (oEvent) {
                this._oData = oEvent.getParameter("data");
            }, this);
			
			Format.numericFormatter(ChartFormatter.getInstance());
			this.getOwnerComponent().getRouter().getRoute("totalSales").attachPatternMatched(this._onRouteMatched, this);
		...
		_onRouteMatched: function(oEvent) {
	        ...
	        switch(groupBy.groupby) {
				...
				case "Month":
					...
					this.date_f.setValue(odate.getMonthGapStart(6));
					this.date_t.setValue(odate.getMonthGapStop());
					this.initChart(odate.getMonthGapStart(6),odate.getMonthGapStop(),2,true,null,null);
					break;
				case "Year":
					this.select = 4;
					...
					this.initChart(odate.getMonthBegin(),odate.getDateFromNow(0),4,true,null,null);
					break;
				case "quarterPlan":
