sap.ui.define([
	...
	"use strict";
	return Object.extend("ecu.controller.manager.TileSalesPlan", {
		header:null,
		saleplan:null,
		actualsale:null,
		value:null,
		constructor : function(header,route,isDate,arg,isBu,bu,map){
			this.customTile = new sap.m.CustomTile();
			this.customTile.addStyleClass("myCustomTile");
			if(!isBu){
				this.gt = new sap.m.GenericTile({
					press : function(){
						route.navTo("salesPlane",{groupby:arg});
					}
				});
			}else {
